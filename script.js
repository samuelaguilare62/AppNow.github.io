...
window.onload = function() {
  setTimeout(function() {
    // Comprobar si la página ha terminado de cargar
    if (document.readyState === 'complete') {
      console.log('La página ha cargado completamente.');
    } else {
      // Mostrar mensaje de carga lenta o redirigir a una página de carga lenta
      console.log('La página está cargando lentamente. Puede haber un problema de conexión.');
    }
  }, 5000); // Esperar 5 segundos para considerar una carga lenta
};
